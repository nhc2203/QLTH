...
var ngayHT = new Date();
export default Login4 = function({navigation}){
    return(
        ...
        resizeMode='stretch' >
            ...
            <SafeAreaView style={{flex:1,width:'100%',height:'100%',justifyContent:'center', alignItems:'center'}}>
                ...
                <View style={{borderTopRightRadius:25, borderBottomRightRadius:25, opacity:0.7,  width:'70%',height:'60%',backgroundColor:'white',justifyContent:'flex-start', alignItems:'center'}}>
                    {/* Phan tren logo */}
                    <View style={{borderWidth:0, flexDirection:'row', height: '30%', width:'100%',justifyContent:'center', alignItems:'center'}}>
                        <View style={{borderWidth:0, height: '100%', width:'10%',justifyContent:'flex-start', alignItems:'center'}}>
                            <TouchableOpacity style={{marginTop:'10%',opacity:1,width:'90%', aspectRatio:1,}}
                                onPress={()=>{Alert.alert("Gợi ý","Bạn đang ở trang giới thiệu 4.\nBạn hãy đăng ký hoặc đăng nhập để sử dụng các tính năng hấp dẫn!.");  navigation.openDrawer()}}>
